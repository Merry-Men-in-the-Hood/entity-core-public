...
Implements the Provider interface for ionet.
"""
...
def deploy_inference_endpoint(model_name: str, vram_gb: int) -> str:
    """Deploy LLM inference endpoint on ionet."""
    raise NotImplementedError("ionet client activates in Mesh-LLM Phase 1.")


def query(endpoint: str, prompt: str, max_tokens: int = 2048) -> str:
    """Query a deployed endpoint."""
    raise NotImplementedError("ionet query activates in Phase 1.")
