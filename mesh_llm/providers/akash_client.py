...
Implements the Provider interface for akash.
"""
...
def deploy_inference_endpoint(model_name: str, vram_gb: int) -> str:
    """Deploy LLM inference endpoint on akash."""
    raise NotImplementedError("akash client activates in Mesh-LLM Phase 1.")


def query(endpoint: str, prompt: str, max_tokens: int = 2048) -> str:
    """Query a deployed endpoint."""
    raise NotImplementedError("akash query activates in Phase 1.")
